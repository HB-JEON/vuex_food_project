<template>
  ...
  <div class="row text-center">
    <ul class="pagination">
        ...
        <li v-for="i, key in foods.range(foods.food_data.startPage, foods.food_data.endPage)" :key="key" :class="i === foods.food_data.curpage ? 'active' : ''" @click="foods.foodListData(i)">
            <a class="">{{ i }}</a>
        </li>
